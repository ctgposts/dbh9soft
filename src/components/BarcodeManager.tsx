      ...
      for (let j = 0; j < actualStickersPerRow && (i + j) < selectedProductsData.length; j++) {
        ...
        htmlContent += `
          <div class="sticker">
            ...
            <div class="barcode-number" style="font-size: max(8px, 0.65vh); font-family: 'Courier New', monospace; font-weight: bold; color: #000; text-align: center; width: 100%; margin: 0.2px 0; padding: 0 0.5px; line-height: 1.05;">${product.barcode}</div>
